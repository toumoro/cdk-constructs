...
#### Initializers <a name="Initializers" id="tm-cdk-constructs.TmSolrEc2.Initializer"></a>

```typescript
import { TmSolrEc2 } from 'tm-cdk-constructs'

new TmSolrEc2(scope: Construct, id: string, props: TmSorlEc2Props)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#tm-cdk-constructs.TmSolrEc2.Initializer.parameter.scope">scope</a></code> | <code>constructs.Construct</code> | *No description.* |
| <code><a href="#tm-cdk-constructs.TmSolrEc2.Initializer.parameter.id">id</a></code> | <code>string</code> | *No description.* |
| <code><a href="#tm-cdk-constructs.TmSolrEc2.Initializer.parameter.props">props</a></code> | <code><a href="#tm-cdk-constructs.TmSorlEc2Props">TmSorlEc2Props</a></code> | *No description.* |

---

##### `scope`<sup>Required</sup> <a name="scope" id="tm-cdk-constructs.TmSolrEc2.Initializer.parameter.scope"></a>

- *Type:* constructs.Construct

---

##### `id`<sup>Required</sup> <a name="id" id="tm-cdk-constructs.TmSolrEc2.Initializer.parameter.id"></a>

- *Type:* string

---

##### `props`<sup>Required</sup> <a name="props" id="tm-cdk-constructs.TmSolrEc2.Initializer.parameter.props"></a>

- *Type:* <a href="#tm-cdk-constructs.TmSorlEc2Props">TmSorlEc2Props</a>
...
| <code><a href="#tm-cdk-constructs.TmSolrEc2.addUserData">addUserData</a></code> | Add command to the startup script of the instance. |
| <code><a href="#tm-cdk-constructs.TmSolrEc2.applyCloudFormationInit">applyCloudFormationInit</a></code> | Use a CloudFormation Init configuration at instance startup. |

---

##### `toString` <a name="toString" id="tm-cdk-constructs.TmSolrEc2.toString"></a>
...
###### `policy`<sup>Required</sup> <a name="policy" id="tm-cdk-constructs.TmSolrEc2.applyRemovalPolicy.parameter.policy"></a>

- *Type:* aws-cdk-lib.RemovalPolicy

---

##### `addSecurityGroup` <a name="addSecurityGroup" id="tm-cdk-constructs.TmSolrEc2.addSecurityGroup"></a>
...
###### `securityGroup`<sup>Required</sup> <a name="securityGroup" id="tm-cdk-constructs.TmSolrEc2.addSecurityGroup.parameter.securityGroup"></a>
...
##### `addToRolePolicy` <a name="addToRolePolicy" id="tm-cdk-constructs.TmSolrEc2.addToRolePolicy"></a>
...
###### `statement`<sup>Required</sup> <a name="statement" id="tm-cdk-constructs.TmSolrEc2.addToRolePolicy.parameter.statement"></a>

- *Type:* aws-cdk-lib.aws_iam.PolicyStatement

---

##### `addUserData` <a name="addUserData" id="tm-cdk-constructs.TmSolrEc2.addUserData"></a>
...
###### `commands`<sup>Required</sup> <a name="commands" id="tm-cdk-constructs.TmSolrEc2.addUserData.parameter.commands"></a>

- *Type:* ...string[]

---

##### `applyCloudFormationInit` <a name="applyCloudFormationInit" id="tm-cdk-constructs.TmSolrEc2.applyCloudFormationInit"></a>
...
###### `init`<sup>Required</sup> <a name="init" id="tm-cdk-constructs.TmSolrEc2.applyCloudFormationInit.parameter.init"></a>

- *Type:* aws-cdk-lib.aws_ec2.CloudFormationInit

---

###### `options`<sup>Optional</sup> <a name="options" id="tm-cdk-constructs.TmSolrEc2.applyCloudFormationInit.parameter.options"></a>
...
| **Name** | **Description** |
| --- | --- |
| <code><a href="#tm-cdk-constructs.TmSolrEc2.isConstruct">isConstruct</a></code> | Checks if `x` is a construct. |
| <code><a href="#tm-cdk-constructs.TmSolrEc2.isOwnedResource">isOwnedResource</a></code> | Returns true if the construct was created by CDK, and false otherwise. |
| <code><a href="#tm-cdk-constructs.TmSolrEc2.isResource">isResource</a></code> | Check whether the given construct is a Resource. |
...
##### `isOwnedResource` <a name="isOwnedResource" id="tm-cdk-constructs.TmSolrEc2.isOwnedResource"></a>

```typescript
import { TmSolrEc2 } from 'tm-cdk-constructs'

TmSolrEc2.isOwnedResource(construct: IConstruct)
```

Returns true if the construct was created by CDK, and false otherwise.

###### `construct`<sup>Required</sup> <a name="construct" id="tm-cdk-constructs.TmSolrEc2.isOwnedResource.parameter.construct"></a>

- *Type:* constructs.IConstruct

---

##### `isResource` <a name="isResource" id="tm-cdk-constructs.TmSolrEc2.isResource"></a>

```typescript
import { TmSolrEc2 } from 'tm-cdk-constructs'

TmSolrEc2.isResource(construct: IConstruct)
```

Check whether the given construct is a Resource.

###### `construct`<sup>Required</sup> <a name="construct" id="tm-cdk-constructs.TmSolrEc2.isResource.parameter.construct"></a>
...
| <code><a href="#tm-cdk-constructs.TmSolrEc2.property.instance">instance</a></code> | <code>aws-cdk-lib.aws_ec2.CfnInstance</code> | the underlying instance resource. |
| <code><a href="#tm-cdk-constructs.TmSolrEc2.property.instanceAvailabilityZone">instanceAvailabilityZone</a></code> | <code>string</code> | The availability zone the instance was launched in. |
| <code><a href="#tm-cdk-constructs.TmSolrEc2.property.instanceId">instanceId</a></code> | <code>string</code> | The instance's ID. |
| <code><a href="#tm-cdk-constructs.TmSolrEc2.property.instancePrivateDnsName">instancePrivateDnsName</a></code> | <code>string</code> | Private DNS name for this instance. |
...
##### `node`<sup>Required</sup> <a name="node" id="tm-cdk-constructs.TmSolrEc2.property.node"></a>
...
##### `env`<sup>Required</sup> <a name="env" id="tm-cdk-constructs.TmSolrEc2.property.env"></a>
...
##### `stack`<sup>Required</sup> <a name="stack" id="tm-cdk-constructs.TmSolrEc2.property.stack"></a>
...
##### `connections`<sup>Required</sup> <a name="connections" id="tm-cdk-constructs.TmSolrEc2.property.connections"></a>
...
##### `grantPrincipal`<sup>Required</sup> <a name="grantPrincipal" id="tm-cdk-constructs.TmSolrEc2.property.grantPrincipal"></a>
...
##### `instance`<sup>Required</sup> <a name="instance" id="tm-cdk-constructs.TmSolrEc2.property.instance"></a>
...
##### `instanceAvailabilityZone`<sup>Required</sup> <a name="instanceAvailabilityZone" id="tm-cdk-constructs.TmSolrEc2.property.instanceAvailabilityZone"></a>
...
##### `instanceId`<sup>Required</sup> <a name="instanceId" id="tm-cdk-constructs.TmSolrEc2.property.instanceId"></a>
...
##### `instancePrivateDnsName`<sup>Required</sup> <a name="instancePrivateDnsName" id="tm-cdk-constructs.TmSolrEc2.property.instancePrivateDnsName"></a>
...
##### `instancePrivateIp`<sup>Required</sup> <a name="instancePrivateIp" id="tm-cdk-constructs.TmSolrEc2.property.instancePrivateIp"></a>
...
##### `instancePublicDnsName`<sup>Required</sup> <a name="instancePublicDnsName" id="tm-cdk-constructs.TmSolrEc2.property.instancePublicDnsName"></a>
...
##### `instancePublicIp`<sup>Required</sup> <a name="instancePublicIp" id="tm-cdk-constructs.TmSolrEc2.property.instancePublicIp"></a>
...
##### `role`<sup>Required</sup> <a name="role" id="tm-cdk-constructs.TmSolrEc2.property.role"></a>
...
##### `userData`<sup>Required</sup> <a name="userData" id="tm-cdk-constructs.TmSolrEc2.property.userData"></a>
...
### TmSorlEc2Props <a name="TmSorlEc2Props" id="tm-cdk-constructs.TmSorlEc2Props"></a>

#### Initializer <a name="Initializer" id="tm-cdk-constructs.TmSorlEc2Props.Initializer"></a>

```typescript
import { TmSorlEc2Props } from 'tm-cdk-constructs'

const tmSorlEc2Props: TmSorlEc2Props = { ... }
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#tm-cdk-constructs.TmSorlEc2Props.property.instanceType">instanceType</a></code> | <code>aws-cdk-lib.aws_ec2.InstanceType</code> | Type of instance to launch. |
| <code><a href="#tm-cdk-constructs.TmSorlEc2Props.property.machineImage">machineImage</a></code> | <code>aws-cdk-lib.aws_ec2.IMachineImage</code> | AMI to launch. |
| <code><a href="#tm-cdk-constructs.TmSorlEc2Props.property.vpc">vpc</a></code> | <code>aws-cdk-lib.aws_ec2.IVpc</code> | VPC to launch the instance in. |
| <code><a href="#tm-cdk-constructs.TmSorlEc2Props.property.allowAllIpv6Outbound">allowAllIpv6Outbound</a></code> | <code>boolean</code> | Whether the instance could initiate IPv6 connections to anywhere by default. |
| <code><a href="#tm-cdk-constructs.TmSorlEc2Props.property.allowAllOutbound">allowAllOutbound</a></code> | <code>boolean</code> | Whether the instance could initiate connections to anywhere by default. |
| <code><a href="#tm-cdk-constructs.TmSorlEc2Props.property.associatePublicIpAddress">associatePublicIpAddress</a></code> | <code>boolean</code> | Whether to associate a public IP address to the primary network interface attached to this instance. |
| <code><a href="#tm-cdk-constructs.TmSorlEc2Props.property.availabilityZone">availabilityZone</a></code> | <code>string</code> | In which AZ to place the instance within the VPC. |
| <code><a href="#tm-cdk-constructs.TmSorlEc2Props.property.blockDevices">blockDevices</a></code> | <code>aws-cdk-lib.aws_ec2.BlockDevice[]</code> | Specifies how block devices are exposed to the instance. You can specify virtual devices and EBS volumes. |
| <code><a href="#tm-cdk-constructs.TmSorlEc2Props.property.creditSpecification">creditSpecification</a></code> | <code>aws-cdk-lib.aws_ec2.CpuCredits</code> | Specifying the CPU credit type for burstable EC2 instance types (T2, T3, T3a, etc). |
| <code><a href="#tm-cdk-constructs.TmSorlEc2Props.property.detailedMonitoring">detailedMonitoring</a></code> | <code>boolean</code> | Whether "Detailed Monitoring" is enabled for this instance Keep in mind that Detailed Monitoring results in extra charges. |
| <code><a href="#tm-cdk-constructs.TmSorlEc2Props.property.disableApiTermination">disableApiTermination</a></code> | <code>boolean</code> | If true, the instance will not be able to be terminated using the Amazon EC2 console, CLI, or API. |
...
| <code><a href="#tm-cdk-constructs.TmSorlEc2Props.property.resourceSignalTimeout">resourceSignalTimeout</a></code> | <code>aws-cdk-lib.Duration</code> | The length of time to wait for the resourceSignalCount. |
| <code><a href="#tm-cdk-constructs.TmSorlEc2Props.property.role">role</a></code> | <code>aws-cdk-lib.aws_iam.IRole</code> | An IAM role to associate with the instance profile assigned to this Auto Scaling Group. |
| <code><a href="#tm-cdk-constructs.TmSorlEc2Props.property.securityGroup">securityGroup</a></code> | <code>aws-cdk-lib.aws_ec2.ISecurityGroup</code> | Security Group to assign to this instance. |
| <code><a href="#tm-cdk-constructs.TmSorlEc2Props.property.sourceDestCheck">sourceDestCheck</a></code> | <code>boolean</code> | Specifies whether to enable an instance launched in a VPC to perform NAT. |
| <code><a href="#tm-cdk-constructs.TmSorlEc2Props.property.ssmSessionPermissions">ssmSessionPermissions</a></code> | <code>boolean</code> | Add SSM session permissions to the instance role. |
| <code><a href="#tm-cdk-constructs.TmSorlEc2Props.property.userData">userData</a></code> | <code>aws-cdk-lib.aws_ec2.UserData</code> | Specific UserData to use. |
...
##### `instanceType`<sup>Required</sup> <a name="instanceType" id="tm-cdk-constructs.TmSorlEc2Props.property.instanceType"></a>
...
##### `machineImage`<sup>Required</sup> <a name="machineImage" id="tm-cdk-constructs.TmSorlEc2Props.property.machineImage"></a>
...
##### `vpc`<sup>Required</sup> <a name="vpc" id="tm-cdk-constructs.TmSorlEc2Props.property.vpc"></a>
...
##### `allowAllIpv6Outbound`<sup>Optional</sup> <a name="allowAllIpv6Outbound" id="tm-cdk-constructs.TmSorlEc2Props.property.allowAllIpv6Outbound"></a>
...
##### `allowAllOutbound`<sup>Optional</sup> <a name="allowAllOutbound" id="tm-cdk-constructs.TmSorlEc2Props.property.allowAllOutbound"></a>
...
##### `associatePublicIpAddress`<sup>Optional</sup> <a name="associatePublicIpAddress" id="tm-cdk-constructs.TmSorlEc2Props.property.associatePublicIpAddress"></a>
...
##### `availabilityZone`<sup>Optional</sup> <a name="availabilityZone" id="tm-cdk-constructs.TmSorlEc2Props.property.availabilityZone"></a>
...
##### `blockDevices`<sup>Optional</sup> <a name="blockDevices" id="tm-cdk-constructs.TmSorlEc2Props.property.blockDevices"></a>
...
##### `creditSpecification`<sup>Optional</sup> <a name="creditSpecification" id="tm-cdk-constructs.TmSorlEc2Props.property.creditSpecification"></a>
...
##### `detailedMonitoring`<sup>Optional</sup> <a name="detailedMonitoring" id="tm-cdk-constructs.TmSorlEc2Props.property.detailedMonitoring"></a>
...
##### `disableApiTermination`<sup>Optional</sup> <a name="disableApiTermination" id="tm-cdk-constructs.TmSorlEc2Props.property.disableApiTermination"></a>
...
##### `ebsOptimized`<sup>Optional</sup> <a name="ebsOptimized" id="tm-cdk-constructs.TmSorlEc2Props.property.ebsOptimized"></a>
...
##### `enclaveEnabled`<sup>Optional</sup> <a name="enclaveEnabled" id="tm-cdk-constructs.TmSorlEc2Props.property.enclaveEnabled"></a>

```typescript
public readonly enclaveEnabled: boolean;
```
...
> [https://docs.aws.amazon.com/enclaves/latest/user/nitro-enclave.html#nitro-enclave-reqs](https://docs.aws.amazon.com/enclaves/latest/user/nitro-enclave.html#nitro-enclave-reqs)

---

##### `hibernationEnabled`<sup>Optional</sup> <a name="hibernationEnabled" id="tm-cdk-constructs.TmSorlEc2Props.property.hibernationEnabled"></a>
...
> [https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ec2-instance-hibernationoptions.html](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ec2-instance-hibernationoptions.html)
...
##### `initOptions`<sup>Optional</sup> <a name="initOptions" id="tm-cdk-constructs.TmSorlEc2Props.property.initOptions"></a>
...
##### `instanceInitiatedShutdownBehavior`<sup>Optional</sup> <a name="instanceInitiatedShutdownBehavior" id="tm-cdk-constructs.TmSorlEc2Props.property.instanceInitiatedShutdownBehavior"></a>
...
##### `instanceName`<sup>Optional</sup> <a name="instanceName" id="tm-cdk-constructs.TmSorlEc2Props.property.instanceName"></a>
...
##### `instanceProfile`<sup>Optional</sup> <a name="instanceProfile" id="tm-cdk-constructs.TmSorlEc2Props.property.instanceProfile"></a>
...
##### `ipv6AddressCount`<sup>Optional</sup> <a name="ipv6AddressCount" id="tm-cdk-constructs.TmSorlEc2Props.property.ipv6AddressCount"></a>
...
##### ~~`keyName`~~<sup>Optional</sup> <a name="keyName" id="tm-cdk-constructs.TmSorlEc2Props.property.keyName"></a>
...
##### `keyPair`<sup>Optional</sup> <a name="keyPair" id="tm-cdk-constructs.TmSorlEc2Props.property.keyPair"></a>
...
##### `privateIpAddress`<sup>Optional</sup> <a name="privateIpAddress" id="tm-cdk-constructs.TmSorlEc2Props.property.privateIpAddress"></a>
...
##### `propagateTagsToVolumeOnCreation`<sup>Optional</sup> <a name="propagateTagsToVolumeOnCreation" id="tm-cdk-constructs.TmSorlEc2Props.property.propagateTagsToVolumeOnCreation"></a>
...
##### `requireImdsv2`<sup>Optional</sup> <a name="requireImdsv2" id="tm-cdk-constructs.TmSorlEc2Props.property.requireImdsv2"></a>
...
##### `resourceSignalTimeout`<sup>Optional</sup> <a name="resourceSignalTimeout" id="tm-cdk-constructs.TmSorlEc2Props.property.resourceSignalTimeout"></a>
...
##### `role`<sup>Optional</sup> <a name="role" id="tm-cdk-constructs.TmSorlEc2Props.property.role"></a>
...
##### `securityGroup`<sup>Optional</sup> <a name="securityGroup" id="tm-cdk-constructs.TmSorlEc2Props.property.securityGroup"></a>
...
##### `sourceDestCheck`<sup>Optional</sup> <a name="sourceDestCheck" id="tm-cdk-constructs.TmSorlEc2Props.property.sourceDestCheck"></a>
...
##### `ssmSessionPermissions`<sup>Optional</sup> <a name="ssmSessionPermissions" id="tm-cdk-constructs.TmSorlEc2Props.property.ssmSessionPermissions"></a>
...
##### `userData`<sup>Optional</sup> <a name="userData" id="tm-cdk-constructs.TmSorlEc2Props.property.userData"></a>
...
##### `userDataCausesReplacement`<sup>Optional</sup> <a name="userDataCausesReplacement" id="tm-cdk-constructs.TmSorlEc2Props.property.userDataCausesReplacement"></a>
...
##### `vpcSubnets`<sup>Optional</sup> <a name="vpcSubnets" id="tm-cdk-constructs.TmSorlEc2Props.property.vpcSubnets"></a>
...
##### `buildContextPath`<sup>Required</sup> <a name="buildContextPath" id="tm-cdk-constructs.TmSorlEc2Props.property.buildContextPath"></a>
...
##### `buildContainerArgs`<sup>Optional</sup> <a name="buildContainerArgs" id="tm-cdk-constructs.TmSorlEc2Props.property.buildContainerArgs"></a>
...
##### `ebsVolumeSize`<sup>Optional</sup> <a name="ebsVolumeSize" id="tm-cdk-constructs.TmSorlEc2Props.property.ebsVolumeSize"></a>
...
##### `hostedZone`<sup>Optional</sup> <a name="hostedZone" id="tm-cdk-constructs.TmSorlEc2Props.property.hostedZone"></a>
...
##### `recordName`<sup>Optional</sup> <a name="recordName" id="tm-cdk-constructs.TmSorlEc2Props.property.recordName"></a>
...
##### `solrJavaMem`<sup>Optional</sup> <a name="solrJavaMem" id="tm-cdk-constructs.TmSorlEc2Props.property.solrJavaMem"></a>

```typescript
public readonly solrJavaMem: string;
```
...
##### `solrOpts`<sup>Optional</sup> <a name="solrOpts" id="tm-cdk-constructs.TmSorlEc2Props.property.solrOpts"></a>
...
##### `ssmPathPrefix`<sup>Optional</sup> <a name="ssmPathPrefix" id="tm-cdk-constructs.TmSorlEc2Props.property.ssmPathPrefix"></a>

```typescript
public readonly ssmPathPrefix: string;
```
